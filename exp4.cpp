...
Inorder traversal with recursion: A * B + C * D
...
Preorder traversal with recursion: + * A B * C D
...
Postorder traversal with recursion: A B * C D * +
...
Inorder traversal without recursion: A * B + C * D
...
Preorder traversal without recursion: + * A B * C D
...
Postorder traversal without recursion: A B * C D * +
